...
import com.rockrecap.data.enums.getMinuteOptionsList
import com.rockrecap.ui.theme.Tertiary
import com.rockrecap.ui.theme.customTextFieldColors

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MinutesDropDownMenu(setValue:String, minutes: (String) -> Unit){
    Column(
        verticalArrangement = Arrangement.spacedBy(8.dp)
    ){
        val options = getMinuteOptionsList().map { it.value }
