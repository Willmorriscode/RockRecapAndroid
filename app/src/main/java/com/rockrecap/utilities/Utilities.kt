...
fun getSeedRoutes(): List<Route> {
    return listOf(
            // ---- BOULDER ----
            Route(name = "Boulder Bash", summary = "Short boulder problem with a powerful move", type = RouteType.BOULDER, color = RouteColor.RED, grade = RouteGrade.V4, timeLogged = 300, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.COMPLETED, startDate = 171372480000L, routeBelongsTo = 1, routeTemplateCreatedBy = 100),
            Route(name = "Slab Sunday", summary = "Technical slab requiring balance", type = RouteType.BOULDER, color = RouteColor.BLUE, grade = RouteGrade.V3, timeLogged = 200, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.INCOMPLETE, startDate = 1713811200000L, routeBelongsTo = 1, routeTemplateCreatedBy = 101),
            Route(name = "Dyno Dynasty", summary = "Big jumps and commitment", type = RouteType.BOULDER, color = RouteColor.TAN, grade = RouteGrade.V6, timeLogged = 250, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.INCOMPLETE, startDate = 1714070400000L, routeBelongsTo = 3, routeTemplateCreatedBy = 103),
            Route(name = "Pebble Puzzler", summary = "Crimpy face climbing", type = RouteType.BOULDER, color = RouteColor.GREEN, grade = RouteGrade.V3, timeLogged = 270, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.COMPLETED, startDate = 1714156800000L, routeBelongsTo = 1, routeTemplateCreatedBy = 104),
            Route(name = "Mantle Madness", summary = "Slopers and mantles", type = RouteType.BOULDER, color = RouteColor.YELLOW, grade = RouteGrade.V2, timeLogged = 220, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.COMPLETED, startDate = 1714243200000L, routeBelongsTo = 2, routeTemplateCreatedBy = 105),
            Route(name = "Blue Cave Route", summary = "Overhanging prow", type = RouteType.BOULDER, color = RouteColor.BLUE, grade = RouteGrade.V4, timeLogged = 310, activeStatus = RouteActiveStatus.ACTIVE, completedStatus = RouteCompleteStatus.COMPLETED, startDate = 1745304005894L, routeBelongsTo = 2, routeTemplateCreatedBy = 106),
            Route(name = "Campus Circuit", summary = "Campus board-style moves", type = RouteType.BOULDER, color = RouteColor.WHITE, grade = RouteGrade.V5, timeLogged = 350, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.COMPLETED, startDate = 1714416000000L, routeBelongsTo = 3, routeTemplateCreatedBy = 107),
            Route(name = "Crux Candy", summary = "One-move wonder", type = RouteType.BOULDER, color = RouteColor.ORANGE, grade = RouteGrade.V3, timeLogged = 280, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.COMPLETED, startDate = 1714502400000L, routeBelongsTo = 3, routeTemplateCreatedBy = 108),
            Route(name = "Grippy Gremlin", summary = "Sharp crimps", type = RouteType.BOULDER, color = RouteColor.GRAY, grade = RouteGrade.V6, timeLogged = 240, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.INCOMPLETE, startDate = 1714588800000L, routeBelongsTo = 3, routeTemplateCreatedBy = 109),
            Route(name = "Hueco Hustle", summary = "Juggy roof", type = RouteType.BOULDER, color = RouteColor.BROWN, grade = RouteGrade.V1, timeLogged = 180, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.INCOMPLETE, startDate = 1714675200000L, routeBelongsTo = 1, routeTemplateCreatedBy = 110),
            Route(name = "Mystery Mountain", summary = "No idea what the topout looks like yet", type = RouteType.BOULDER, color = RouteColor.WHITE, grade = RouteGrade.V4, timeLogged = 180, activeStatus = RouteActiveStatus.INACTIVE, completedStatus = RouteCompleteStatus.COMPLETED, startDate = 1714675200000L, routeBelongsTo = 1, routeTemplateCreatedBy = 110),
